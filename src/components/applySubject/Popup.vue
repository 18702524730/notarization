...
<div class="sebe-dialog__wrapper">
  <div class="sebe-dialog sebe-dialog--small apply-popup" style="top: 50%;">
    ...
    <div class="sebe-dialog__body">
      <sebe-apply-subject :formData="formData" :typeList="typeList" :parApplyType="formData.apply_type || typeList.slice(0,1)-0" @getIsLogin="getIsLogin" @addSuccess="addSuccess"></sebe-apply-subject>
    </div>
  </div>
</div>
</template>
...
.sebe-dialog__wrapper {
  ...
  .apply-popup{
    width:650px;min-height:300px;padding:20px 30px 34px;
