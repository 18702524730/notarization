    ...
    <el-form ref="ruleForm" :rules="rules" :model="conForm" label-width="172px">
      ...
      <div>
        <el-form-item label="申请人企业名称：" prop="apply_name">
          <el-input v-model ="conForm.apply_name" :maxlength="60" placeholder="请填写申请人企业名称，与企业营业执照信息保持一致" :disabled="isEdit && conForm.is_checked && conForm.is_checked != 4"></el-input>
        </el-form-item>
        <el-form-item label="统一社会信用代码：" prop="apply_number">
          <el-input v-model ="conForm.apply_number" :maxlength="18" placeholder="请填写统一社会信用代码" :disabled="isEdit && conForm.is_checked && conForm.is_checked != 4"></el-input>
        </el-form-item>
        ...
        <el-form-item label="企业地址：" class="form-ipt-sm-wrap" required>
        ...
        <el-form-item class="dlqy_upload_wrap" label="企业营业执照副本复印件（加盖公章）：" prop="standby1">
          <div class="upload_component">
            <uploader @complete="setUploadedData" @resetUploader="resetUploader" :valueName="'standby1'" :url="standby1" :fileName="standby1_name" :size="2" :extensions="'pdf,jpg,jpeg,png'" :postAction="userUrl+'/api/file/uploadImgToPdf'" :isDialog="true" :canPreview="true" name="Filedata" :disabled="isEdit && conForm.is_checked && conForm.is_checked != 4"></uploader>
            <div class="upload_tip">
              <p>请上企业营业执照副本复印件，并加盖企业公章</p>
...
const userUrl = CONFIG.userUrl; // 使用代理，规避ie9部分接口兼容问题
  ...
  data () {
    ...
    return {
      ...
      rules:{
        ...
        province_id:[
          { required: true, message: '请选择省份', trigger: 'visible-change' }
        ],
        city_id:[
          { required: true, message: '请选择城市', trigger: 'visible-change' }
        ],
        area_id:[
          { required: true, message: '请选择区', trigger: 'visible-change' }
        ],
        address:[
...
<style lang="scss">
.dlqyForm{
  width: 590px;height: 650px;
  .el-form-item__content{
    height: 36px;
  }
  .form-ipt-sm-wrap, .dlqy_upload_wrap{
    > .el-form-item__content{
      height: auto;
    }
  }
