...
module.exports = {
  ...
  build: {
    ...
    index: path.resolve(__dirname, '../notarization/index.html'),
    assetsRoot: path.resolve(__dirname, '../notarization'),
  ...
  dev: {
    ...
    proxyTable: {
      ...
      '/iprp_portal': {
        ...
        //target: 'http://192.168.1.150:8070',
        changeOrigin: true,
        cookieDomainRewrite: "",
        pathRewrite: {'^/iprp_portal' : ''}
      },
      '/ipp': {
      ...
      '/cnsebe-notarization-web': {
        // target: 'http://192.168.1.150:85',
        target:  'https://testcz.ipsebe.com',
        changeOrigin: true,
        pathRewrite: {'^/cnsebe-notarization-web' : ''},
        cookieDomainRewrite: "",
      },
      '/sp': {
        // target: 'http://192.168.1.150:85',
